...
export const projects: Project[] = [
  {
    ...
    tags: ['Go', 'Docker', 'Security', 'Runtime', 'Testing'], status: 'CURRENT BUILD', tone: 'pink',
  ...
  },
  {
    ...
    tags: ['Go', 'TypeScript', 'Metrics', 'Observability'], status: 'SYSTEM BUILD', tone: 'blue',
  ...
  },
  {
    ...
    tags: ['Java', 'Go', 'RabbitMQ', 'PostgreSQL', 'Saga Pattern'], status: 'THESIS TRACK', tone: 'yellow',
  ...
  },
  {
    ...
    tags: ['Astro', 'CSS', 'Design System', 'Cloudflare'], status: 'LIVE BUILD', tone: 'green',
